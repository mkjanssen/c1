...
\frame{
	...
	\begin{enumerate}
	\item Identify the quantities that are changing over time $t$
	\item Find the rates of change of the changing quantities
	\item Find an equation that relates the changing quantities
	\item Differentiate implicitly with respect to time
	\item Evaluate at the relevant instant
\end{enumerate}

}

\frame{
	\frametitle{Activities 3.5.2-3.5.3}

}


\frame{
	\frametitle{Activities 3.5.4-3.5.5}
