...
\title{\S 2.4: Derivatives of Other Trig Functions}
%\subtitle{Welcome!}
...
\frame{
	...
	\textbf{Upshot:} we can express all trig functions in terms of sine and cosine, and find their derivatives using the product and quotient rules
...
\frame{
	\frametitle{Activity 2.4.2-2.4.3}
	
	Recall: the domain of a function $f(x)$ is the set of all allowed inputs
...
\frame{
	\frametitle{Activity 2.4.4: The meaning of the derivative}
