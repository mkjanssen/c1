...
\title{\S 3.4: Applied Optimization}
%\subtitle{Welcome!}
...
\frame{
	...
	\begin{itemize}
		\item Reflection on beauty due Monday
	\end{itemize}
...
\frame{
	\frametitle{Strategies for Solving Applied Problems}
	
	\begin{itemize}
	\item Draw a picture and introduce variables--what quantities can vary?
	\item Identify the quantity to be optimized
	\item Determine a function of a single variable that models the quantity to be optimized \rem{relationship to other vars?}
	\item What is the domain of the function to be optimized? What does physics dictate?
	\item Use calculus to optimize
	\item Answer the original question
\end{itemize}

}

\frame{
	\frametitle{Activities 3.4.2-3.4.3}
	
	\pause
	
	\begin{center}
		\includegraphics[width=3in]{img/3_4_Act2-eps-converted-to.pdf}
	\end{center}

}

\frame{
	\frametitle{Activities 3.4.4-3.4.5}
	
	\pause
	
	\begin{center}
		\includegraphics[width=3in]{img/3_4_Act4-eps-converted-to.pdf}
	\end{center}
