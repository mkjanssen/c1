...
\title{\S 2.2: Derivatives of Sine and Cosine}
%\subtitle{Welcome!}
...
\frame{
	...
	\begin{itemize}
	\item EPs
	\item Schedule your CoL	interviews if you haven't! No grade will be entered until after the interview
\end{itemize}
...
\frame{
	...
	\begin{itemize}
	\item What is $ \frac{d}{dx} [\sin x]$?
	\item What is $ \frac{d}{dx} [\cos x]$?
\end{itemize}

}

\section{Activities 2.2.2-2.2.3}

\frame{
	\frametitle{Activity 2.2.2}
	
	\pause
	
	\begin{center}
		\includegraphics[width=5.5in]{img/2_2_sineSoln.pdf}
	\end{center}

}
\frame{
	\frametitle{Activity 2.2.3}
	
	\pause
	
	\begin{center}
		\includegraphics[width=5.5in]{img/2_2_cosineSoln.pdf}
	\end{center}
...
\frame{
	\frametitle{Derivative Formulae}
