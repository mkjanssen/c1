...
\title{\S 1.1-1.2: Velocity/Limits}
%\subtitle{Welcome!}
...
\frame{
	\frametitle{What is the Activities Upload Assignment?}
	
	Each day we'll work on activities from the workbook you bought at the campus store.
	
	At the end of the week, you scan and upload your workbook pages from the week (if participating in class on Fridays, include that day's activities as well).
...
\section{Section 1.2: The Notion of Limit}
...
\item Edfinity Section 1.1 due Wednesday
