...
\title{\S 2.7: Implicit Differentiation}
%\subtitle{Welcome!}
...
\frame{
	...
	\begin{center}
		\includegraphics[width=3in]{img/cardioid.png}
		
		$(x^2+y^2)^2 +8x (x^2+y^2) = 16 y$
	\end{center}
...
\frame{
	\frametitle{Activity 2.7.2}

}

\frame{
	\frametitle{Horizontal and Vertical Tangents}
	...
	The horizontal tangent is when:
	
	\bigskip
	
	The vertical tangent is when: 

}


\frame{
	\frametitle{Activities 2.7.3-2.7.4}
