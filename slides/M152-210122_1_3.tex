...
\title{\S 1.3: The Derivative of a Function at a Point}
%\subtitle{Welcome!}
...
%	
%	\begin{itemize}
%	\item Prep discussion
%	\item Average $\to$ Instantaneous
%	\item The limit definition of the derivative at a point
%\end{itemize}
%	
%	
%
...
\frame{
	...
	\begin{itemize}
	\item If a function has a derivative at $x=a$ we say it is \emph{differentiable} there.
	\item The derivative at a point generalizes the notion of instantaneous velocity\
	\item What are the units on $f'(a)$?
...
\frame{
	\frametitle{Activity 1.3.3}

}

\frame{
	\frametitle{Activity 1.3.4}
